...
class Point:
    ...
    def __reward(self):
        ...
        if self.type == States.FOOD:
            return Point.REWARDS[States.FOOD] * exp(Point.SPACE_COUNT / Point.MU)
...
class MDPAgent(Agent):
    ...
    Convergence approximation:
            ...
            where delta is MAX(ABS(Ucopy(s) - U(s)))
    '''
